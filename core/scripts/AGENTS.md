...
Utility scripts run during core development (e.g., schema validation). Execute
...
- Scripts that mutate compiled artifacts should print the target IR version and hash to help diagnose cache drift.
